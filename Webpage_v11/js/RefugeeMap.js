...
/*Thanks to Maria's contribution***/
...
RefugeeMap.prototype.initVis = function() {
    ...
    // ------------------------------------------------------------------------------
    // Initialize longitude / latitude jitter (to better see camps at the same place)
    // Source: Maria's code
    // ------------------------------------------------------------------------------
    vis.jitter = 0.1;
    ...
    // This is to get the most recent camp data
    ...
    // -------------------------------------------------------------------------
    // Initialize Refugee Camps (the last data point)
    // -------------------------------------------------------------------------
